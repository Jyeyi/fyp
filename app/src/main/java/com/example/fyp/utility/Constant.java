...
public class Constant {
    ...
    public static final String INTENT_FROM_LOCATION = "fromLocation";
    public static final String INTENT_DEPARTURE_TIME = "departureTime";
    public static final String INTENT_DEPARTURE_DATE = "departureDate";
    public static final String INTENT_ARRIVED_TIME = "arrivedTime";
    public static final String INTENT_ARRIVED_DATE = "arrivedDate";
